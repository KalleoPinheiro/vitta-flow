...
**Done when**:
- [x] Repositório e rotas de agendamento escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento (leitura e escrita)
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositório e rotas de procedimento escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento E que o mesmo nome de procedimento em ambas não colide
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositório e rotas de profissional escopados por `clinic_id`
...
**Done when**:
- [x] Repositórios e rotas de condição clínica e avaliação escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento das duas entidades
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositório e rotas de nota de evolução escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositório e rotas de anamnese escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositórios e rotas de plano de cuidado (+3 filhas), avaliação de desfecho e registro de intervenção escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento de cada entidade
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositórios e rotas de retorno e lembrete escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento das duas entidades
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositório e rotas de consentimento escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo
...
**Done when**:
- [x] Repositórios e rotas de fatura, pacote de sessões e consumo de pacote escopados por `clinic_id`
- [x] Teste de rota com 2 clínicas prova isolamento das três entidades
- [x] `npm run typecheck && npx vitest run tests/api tests/infrastructure` limpo

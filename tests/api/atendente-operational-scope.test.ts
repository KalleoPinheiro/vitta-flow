...
describe('Feature: Restrição operacional do Atendente (RBAC-15/16)', () => {
  const atendenteHeaders = () =>
    cookieHeaderFor('atendente', 'atendente@x.com', CLINIC_A_ID);
